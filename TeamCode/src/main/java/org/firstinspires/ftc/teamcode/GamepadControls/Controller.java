...
public class Controller {
    ...
    //wtf?
    public void rumble(int millisecond){
        this.src.rumble(millisecond);
    }
    public void rumble(double rumblePower, int milliseconds) {
        this.src.rumble(rumblePower, rumblePower, milliseconds);
    }
